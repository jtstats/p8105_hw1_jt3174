...
Question2 = tibble(
  normsampx = rnorm(500),
  normsampy = rnorm(500),
  logicalz = normsampx + normsampy > 1,
...
* The mean of normsampx is `r mean(pull(Question2, normsampx))`.

* The medium of normsampx is `r median(pull(Question2, normsampx))`.

* The standard deviation of normsampx is `r sd(pull(Question2, normsampx))`.

* The proportion of cases for which normsampx + normsampy > 1 is `r sum(zcount)/length(pull(Question2, normsampx))`
...
# Scatterplot:
## Question: Does this mean normsampy vs normsampx? OR normsampx vs normsampy?
## Question Solved. 
## Question: Can I directly use normsampx and normsampy in this ggplot function?
ggplot(Question2, aes(x = normsampx, y = normsampy, color = logicalz)) + geom_point()
ggsave("scatterplot1.jpg")

ggplot(Question2, aes(x = normsampx, y = normsampy, color = numerica)) + geom_point()
ggplot(Question2, aes(x = normsampx, y = normsampy, color = factorb)) + geom_point()
